<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="DriversDeleteList.aspx.cs" Inherits="BMTemplate.DriversDeleteList" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <h3 class="PageTitle" id="HeaderControl" runat="server">Delete Driver Details</h3>
    <fieldset style="border-radius: 5px; box-shadow: 5px 5px 2px #888888;">
        <legend id="legend1">Search Driver Entries to Delete</legend>
        <table class="Normaltable">
            ...
            <tr>
                <td colspan="2">
                    <asp:GridView ID="grdDrivers" runat="server" CssClass="GridTable"
                        AutoGenerateColumns="False" AllowPaging="True"
                        DataKeyNames="DriverIdNumber" Width="890"
                        OnPageIndexChanging="grdDrivers_PageIndexChanging"
                        OnRowDeleting="grdDrivers_RowDeleting">
                        <Columns>
                            <asp:BoundField DataField="DriverIdNumber" HeaderText="ID Number" ReadOnly="True" SortExpression="DriverIdNumber" ItemStyle-Width="120" />
                            ...
                            <asp:BoundField DataField="EmergenceContactNo" HeaderText="Emergency ContactNo" SortExpression="EmergenceContactNo" ItemStyle-Width="100" />
                            ...
                            <asp:TemplateField ItemStyle-Width="60" HeaderText="Action">
                                <ItemTemplate>
                                    <asp:LinkButton Text="Delete" ID="btnDelete" CommandName="Delete" runat="server" OnClientClick="return confirm('Are you sure you want to delete this Record?');" />
                                </ItemTemplate>
                            </asp:TemplateField>
