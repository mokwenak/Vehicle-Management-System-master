<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="VehiclesDeleteList.aspx.cs" Inherits="BMTemplate.VehiclesDeleteList" %>
            ...
            <tr>
                <td colspan="2">
                    <asp:GridView ID="grdVehicles" runat="server" CssClass="GridTable" AutoGenerateColumns="False" AllowPaging="True"
                        DataKeyNames="VehicleId" OnRowDeleting="grdVehicles_RowDeleting" OnPageIndexChanging="grdVehicles_PageIndexChanging">
                        <Columns>
